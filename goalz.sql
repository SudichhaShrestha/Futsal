...
INSERT INTO `futsal_info` (`name`, `img_path` , `discription` , `location`, `parking_available`, `price_per_hour`, `opening_time`, `closing_time`) VALUES
...
CREATE TABLE bookings (
    ...
    FOREIGN KEY (futsal_id) REFERENCES futsal_info(id)
);
